...
//                R.layout.event_item,
//                R.id.event_name,
//                getEventNames() //could get string Array;
//        );
...
//        eventListView.setAdapter(adapter);
        ...
        //base on the screen size to create different fragment to show
                ...
                mDatabase.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(username) && (password.equals(dataSnapshot.child(username).child("password").getValue()))) {
                            ...
                            //begin MainActivity send Intent to EventActivity.class
